                        ...
                        <div class="main-body">
                            <div class="col-lg-8">
                                ...
                                <div class="input-group">
                                    <input id="busc_paquete" name="busc_paquete" type="text" class="form-control bg-light border-0 small" placeholder="Buscar un paquete..." aria-label="Search" aria-describedby="basic-addon2" style="display: none;">
                                    <div class="input-group-append">
                                        <button class="btn btn-primary" type="button" style="display: none;" id="conductor-found">
